...
#define CodedOperationMode 1; //Hard coded operation mode
...
int intNumberOfBlinks = 600; //600; //300;		//Number of blinks for a blinkcycle
int intLightOnTime = 600; //600; //300;			//The time the light should be on
